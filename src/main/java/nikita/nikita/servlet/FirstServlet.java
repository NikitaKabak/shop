...
public class FirstServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/nikita/nikita/jsp/startpage.jsp").forward(request, response);
        ...
        switch (request.getParameter("nameButton")) {
            ...
            case "login":
                ...
                if (loginU.equals("") || passwordU.equals("") ){
                    ...
                    if (passwordU.equals(pass)){
                        request.getRequestDispatcher("/nikita/nikita/jsp/homepage.jsp").forward(request, response);
                    } else
                    {
                        request.getRequestDispatcher("/nikita/nikita/jsp/loginError.jsp").forward(request, response);
                    }
            ...
            case "Reg":
                ...
                if (nameUser.equals("") || passwordUser.equals("") || emailUser.equals("") ){
                    ...
                    request.getRequestDispatcher("/nikita/nikita/jsp/users.jsp").forward(request, response);
                }
                break;
            case "registracion":
            ...
            case "showUser":
                ...
                request.getRequestDispatcher("/nikita/nikita/jsp/userInfo.jsp").forward(request, response);
            ...
            case"showAllusers":
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/nikita/nikita/jsp/usersInfo.jsp");
                rd.forward(request, response);
                break;
            default:
